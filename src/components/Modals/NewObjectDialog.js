...
//                             <p className="mt-2" style={{ fontSize: "13px" }}>
//                                 Upload for AI-powered classification
//                             </p>
//                             <AiMultiFileUpload  guid={selectedVault?.guid} userId={mfilesId} email={user?.email}/>
//                         </div>
...
//         <DialogActions>
//             <Button sx={{ textTransform: 'none' }} className='mx-2 rounded-pill' color="warning" size='medium' variant="contained" onClick={onClose}>
//                 Close
//             </Button>
//             <Button sx={{ textTransform: 'none', fontSize: '12px' }} className='mx-4 rounded-pill' color="primary" size='medium' variant="contained" onClick={onDontUseTemplates}>
...
//                                 // The component will refresh automatically
//                             }}
//                             item={prop}
...
//                     FROM TEMPLATE:
//                 </Typography>
//                 <Box className="my-2" sx={{ flexBasis: '65%', fontSize: '13px', textAlign: 'start', ml: 1, fontSize: '13px', color: '#555b6e' }}>
//                     <span className='mx-2'>
//                         <FileExtIcon
//                             fontSize={'20px'}
...
//                 // Only open the data dialog if we're not adding a valuelist item
...
//         const isFileRequired = props.selectedObjectId === 0 && !props.templateIsTrue && !uploadedFile;
...
//             if (!props.templateIsTrue) {
//                 // Handle file upload if creating new object
//                 if (props.selectedObjectId === 0 && uploadedFile) {
//                     const formData = new FormData();
//                     formData.append('formFiles', uploadedFile);
...
//             // Only close parent modal if we're not adding a valuelist item
//             if (!addingValueListItem) {
//                 props.closeModal();
//             }
...
//     }, [filteredProperties, props, uploadedFile, closeFormDialog, addingValueListItem]);
