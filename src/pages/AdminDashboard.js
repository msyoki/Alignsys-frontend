                ...
                <main className={`content ${sidebarOpen ? 'shifted' : 'full-width'}`}>
                    <div id="container" ref={containerRef} style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', backgroundColor: '#fff' }}>
                        <div id="col1" ref={col1Ref} style={{ width: isMobile ? '100%' : '30%', backgroundColor: '#fff', minWidth: '35%', minHeight: '100vh' }}>
                            <HeaderBox className="shadow-lg" sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                <Box
                            ...
                            <HeaderBox className="shadow-lg" sx={{ backgroundColor: '#eef2f7' }}>
                                <span style={{ fontSize: '14px' }} className='text-dark'>Vaults ({user.vaultcount})</span>
                            </HeaderBox>
                            ...
                            <Stack spacing={1} sx={{ p: 2, alignItems: 'center' }}>
                                ...
                                <Button
                                    ...
                                    sx={{ width: '60%', color: '#fff', textTransform: 'none' }}
                                >
                            ...
                            {viewStates.vaultUsers && (
                                <div className='p-2' id='vaultusermanagement' style={{ fontSize: '13px' }}>
                                    <h6 className='shadow-lg p-2'>
                                        ...
                                        <span style={{ color: '#2757aa' }}>  {toSentenceCase(selectedItems.vault.name)}</span> Login Accounts
                                    </h6>
                                    <VaultUsersTable
