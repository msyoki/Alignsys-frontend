      ...
      <div className="left-side">
        <form onSubmit={loginUser} className="text-center text-dark p-3">
          <div>
            ...
            <p className="text-center responsive-font my-2" style={{ fontSize: '13px' }}>
              <span className='mx-1'>Welcome to</span> <b style={{ color: "#e76f51" }}>ZEN</b>Files
            </p>
          </div>
          ...
          <div className="d-flex justify-content-between align-items-center mb-2">
            <p className='small'>
              <a href={`${constants.auth_api}/api/reset_password/`} style={{ textDecoration: 'none', color: 'black' }}>Forgot password?</a>
            </p>
          </div>
          ...
          <small className="small mb-0">
            Don't have an account?<br />Register your <Link to={'/register'} style={{ textDecoration: 'none', color: '#2364aa' }}>Organization account</Link>
          </small>
        </form>
      </div>
